...
public final class MovieMaps {
    ...
    public final static Map<String, TitleType> TITLE_TYPES = Map.ofEntries(
            new AbstractMap.SimpleEntry<>("audiobook", TitleType.AUDIO_BOOK),
            new AbstractMap.SimpleEntry<>("episode", TitleType.EPISODE),
            new AbstractMap.SimpleEntry<>("movie", TitleType.MOVIE),
            new AbstractMap.SimpleEntry<>("radioSeries", TitleType.RADIO_SERIES),
            ...
            new AbstractMap.SimpleEntry<>("tvShort", TitleType.TV_SHORT),
